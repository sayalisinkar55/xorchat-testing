...
public class chatBoxLandingPg {
    ...
    By cancelBtn=By.xpath("cancelButton");
 ...
 */
	 ...
	 {
		 WebDriverWait wait = new WebDriverWait(driver, 10);
		 WebElement btnCancel= wait.until(ExpectedConditions.elementToBeClickable(cancelBtn));
		 btnCancel.click();
		 Thread.sleep(10000);
  ...
  public void varifySearchIcon()
  {
	...
	{
		WebDriverWait wait = new WebDriverWait(driver, 20);
		WebElement  downloadChatIcon =wait.until(ExpectedConditions.presenceOfElementLocated(cancelBtn));
